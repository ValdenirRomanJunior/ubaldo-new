...
const Informations = () => {
    ...
    return(
        ...
        <ModalLinkQuestion openLink={openModalLink}>
            ...
            <h2 className="title-modal-link-question">Politica de Privacidade</h2>
            </div>
            ...
            <p className="text-modal-link-question">Não custa lembrar, prezamos muito pela sua privacidade. 
                ...
                e somente as usaremos para os fins aqui descritos e autorizados por você, principalmente para que você possa utilizar a ZapSign de forma plena,
